...
% nodes on them, we ALWAYS have to assemble like this.
    ...
    Fd1store(EGDOFTac) = Fd1store(EGDOFTac) + ElemFTemp;
    ...
    Kddstore(EGDOFTac,EGDOFTac) = Kddstore(EGDOFTac,EGDOFTac) + ElemKTemp2;
    ...
    Kdfstore(EGDOFTac,EGDOFTic) = Kdfstore(EGDOFTac,EGDOFTic) + ElemKTemp2;
    ...
    Kfdstore(EGDOFTic,EGDOFTac) = Kfdstore(EGDOFTic,EGDOFTac) + ElemKTemp2;
    ...
    Kffstore(EGDOFTic,EGDOFTic) = Kffstore(EGDOFTic,EGDOFTic) + ElemKTemp2;
