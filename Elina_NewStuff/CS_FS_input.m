...
rskip = 0;
type = 'cart';
[xlGrain,NodesOnElementGrain,RegionOnElementGrain,numnpGrain,nunmelGr] = block2d(type,numgh,numgh,node1,elmt1,mat,rskip,btype,xlRVE,nen);
xlGrain = xlGrain';
NodesOnElementGrain = NodesOnElementGrain';
