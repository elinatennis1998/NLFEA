...
% 2/11/2014
% UIUC
% Generalized alpha method dynamic element, 2-D
% Linear kinematics, but set up as a nonlinear element
...
%%
    case 3 %Compute Stiffness and Residual
        ...
        for ll = 1:lint                    
            ...
            ElemK = ElemK + c1*(coeffk*Bmat'*Dmat*Bmat + coeffm*Nmat'*rho*Nmat);
    ...
    case 12 % energy
        ...
        for ll = 1:lint
              ...
              Nmat(2,(ie-1)*2+2) = shl(ie);
                ...
                c1 = Wgt*Jdet*thick;
                ElemE = ElemE + c1/2*E'*D*E + c1/2*velo'*rho0*velo;
