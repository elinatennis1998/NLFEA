...
% Tim Truster
% UIUC
% Nonlinear large strain elasticity DG element, 3D
% Used to confirm quadratic convergence of general element routine.
% Debugged and verified 01/1/2014 to give quadratic convergence for
% TT8U2DG2.m, ep = 20;
...
%         h = 2/(intedge/volR + intedge/volL);
        ...
        for ie = 1:lint
            ...
            [FL,JxXL,fiL] = kine3d(QxyL,ulL,nelL,0);
            PL = muL*(FL - fiL') + lamL*(JxXL^2-JxXL)*fiL';
            [FR,JxXR,fiR] = kine3d(QxyR,ulR,nelR,0);
