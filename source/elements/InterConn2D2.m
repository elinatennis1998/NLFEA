...
%                 lintxy1 = xlintR*shl;
        ...
        elseif nelRB == 3
            ...
            elseif nodeAR == -1 %no enrichment but DG instead
                ...
                eR2 = POUxi(1);
                xlintR(:,2) = xy;
            elseif nodeAR == 0 %conforming mesh
                eR2 = 1;
                xlintR(:,2) = xlR(:,2);
            ...
            elseif nodeBR == -1 %no enrichment but DG instead
                ...
                eR1 = POUxi(1);
                xlintR(:,1) = xy;
            elseif nodeBR == 0 %conforming mesh
                eR1 = 0;
                xlintR(:,1) = xlR(:,1);
...
%                 lintratio = lside12/lside14;
%                 lintxy1 = (xlintR(:,4)-xlintR(:,1))*lintratio + xlintR(:,1);
%                 POUxi = POU_Coord(lintxy1(1),lintxy1(2),xlR,0,nelR);
%                 shl = shlq(eR1,POUxi(2),nelR,nelR,0,0);
%                 lintxy1 = xlR*shl;
%                 xlintR(:,4) = lintxy1;
%                 shl = shlq(eR2,POUxi(2),nelR,nelR,0,0);
%                 lintxy2 = xlR*shl;
%                 xlintR(:,3) = lintxy2;
%             elseif shortyn && lside14 >= lside23
%                 lintratio = lside12/lside23;
...
%                 lintratio = lside12/lside13;
%                 lintxy1 = (xlintR(:,3)-xlintR(:,1))*lintratio + xlintR(:,1);
%                 shl = shlt(1-lintratio,lintratio,nelR,nelR,0,0);
%                 lintxy2 = xlR*shl;
%                 xlintR(:,3) = (lintxy1 + lintxy2)/2;
%             elseif shortyn && lside13 >= lside23
%                 lintratio = lside12/lside23;
%                 lintxy1 = (xlintR(:,3)-xlintR(:,2))*lintratio + xlintR(:,2);
%                 POUxi = POU_Coord(lintxy1(1),lintxy1(2),xlR,1,nelR);
%                 shl = shlt(0,POUxi(2),nelR,nelR,0,0);
%                 lintxy2 = xlR*shl;
%                 xlintR(:,3) = (lintxy1 + lintxy2)/2;
%             end
%         
...
%                 lintratio = lside12/lside14;
%                 lintxy1 = (xlintL(:,4)-xlintL(:,1))*lintratio + xlintL(:,1);
%                 POUxi = POU_Coord(lintxy1(1),lintxy1(2),xlL,0,nelL);
%                 shl = shlq(eL1,POUxi(2),nelL,nelL,0,0);
%                 lintxy1 = xlL*shl;
%                 xlintL(:,4) = lintxy1;
%                 shl = shlq(eL2,POUxi(2),nelL,nelL,0,0);
%                 lintxy2 = xlL*shl;
%                 xlintL(:,3) = lintxy2;
%             elseif shortyn && lside14 >= lside23
%                 lintratio = lside12/lside23;
...
%                 lintratio = lside12/lside13;
%                 lintxy1 = (xlintL(:,3)-xlintL(:,1))*lintratio + xlintL(:,1);
%                 shl = shlt(1-lintratio,lintratio,nelL,nelL,0,0);
%                 lintxy2 = xlL*shl;
%                 xlintL(:,3) = (lintxy1 + lintxy2)/2;
%             elseif shortyn && lside13 >= lside23
%                 lintratio = lside12/lside23;
%                 lintxy1 = (xlintL(:,3)-xlintL(:,2))*lintratio + xlintL(:,2);
%                 POUxi = POU_Coord(lintxy1(1),lintxy1(2),xlL,1,nelL);
%                 shl = shlt(0,POUxi(2),nelL,nelL,0,0);
%                 lintxy2 = xlL*shl;
%                 xlintL(:,3) = (lintxy1 + lintxy2)/2;
%             end
%         
