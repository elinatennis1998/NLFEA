...
% 08/19/2015
%
% Copy of NL_Elem5_1dEquiv to begin adjusting
%
...
%%
    case {3,6} %Compute Stiffness and Residual
...
%                                - (Nmat - (Nbeta*tstep^2)*Dmat*BBmat)'*tau*(Nmat - (Nbeta*tstep^2)*Dmat*BBmat));
        ...
        % Final formulas
        ElemM = ElemM*(1-tau); % combined mass
        ElemK = ElemK; % combined stiffness
%         ElemF = -(ElemM*alres + Nbeta*tstep^2*ElemK*alres + ElemK*ulpres);
