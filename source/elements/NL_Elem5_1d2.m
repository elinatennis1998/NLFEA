...
% 08/21/15 - equivalent rewriting of the ElemK and F using the pred-corr
% displacement instead of just predicted.
...
%%
    case 3 %Compute Stiffness and Residual
        ...
        for ll = 1:lint                    
            ...
            ElemM = ElemM + c1*Bmat'*(Nbeta*tstep^2)*Dmat*Bmat;
        ...
        ElemF = ElemF - (ElemK-(1-tau)*ElemM)*alres;
