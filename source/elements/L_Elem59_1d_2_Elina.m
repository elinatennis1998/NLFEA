...
%Subroutin for 1D solid element DG application in particular
%The subroutine is created to work with solids of different polinomial
%order
...
%%
    case 25 %Stress Projections 
     ...
     %interpolation
        ...
        %End of Dr. Truster's addition
        
        for j = 1:lint
            [Nmat,DerN] = shf1d_Elina_M(r(j),ndm,ndf,p-1,1);
