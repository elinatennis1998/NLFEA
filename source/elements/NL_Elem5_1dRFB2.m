...
% A second shape function is added for the other RFB for the linear shape
% function part of the residual.
...
Me = ...
[                                            h/3,                                            h/6,                                                h/2 - e + (2*e)/(exp(h/e) + 1),                                                                                                (2*e)/(exp(h/e) - 1) - (2*e^2 - e*h + h^2/6)/h
                                             h/6,                                            h/3,                                                h/2 - e + (2*e)/(exp(h/e) + 1),                                                                                                (2*e^2 - e*h + h^2/6)/h - (2*e)/(exp(h/e) - 1)
                  h/2 - e + (2*e)/(exp(h/e) + 1),                 h/2 - e + (2*e)/(exp(h/e) + 1), (3*e + h - 3*e*exp((2*h)/e) + 4*h*exp(h/e) + h*exp((2*h)/e))/(exp(h/e) + 1)^2,                                                                                                                                             0
  (2*e)/(exp(h/e) - 1) - (2*e^2 - e*h + h^2/6)/h, (2*e^2 - e*h + h^2/6)/h - (2*e)/(exp(h/e) - 1),                                                                             0, (8*e^2*exp((2*h)/e) + (h^2*exp((2*h)/e))/3 + 3*e*h + 8*e^2 + h^2/3 - exp(h/e)*(16*e^2 + (8*h^2)/3) - 3*e*h*exp((2*h)/e))/(h*(exp(h/e) - 1)^2)];
Ke = ...
[  cwave^2/h, -cwave^2/h,                                                                      0,                                                                                                                      0
  -cwave^2/h,  cwave^2/h,                                                                      0,                                                                                                                      0
           0,          0, (cwave^2*(e*(exp((2*h)/e) - 1) - 2*h*exp(h/e)))/(e^2*(exp(h/e) + 1)^2),                                                                                                                      0
           0,          0,                                                                      0, -(cwave^2*(e*h*(4*e + h + 4*e*exp((2*h)/e) - h*exp((2*h)/e)) - h*exp(h/e)*(8*e^2 + 2*h^2)))/(e^2*h^2*(exp(h/e) - 1)^2)];
        ...
        for ll = 1:2                    
            ...
            c1 = -1/(exp(a) - exp(-a));
            c2 = -c1;
            db = 2*a/h*(c1*exp(a*sw(1,ll)) - c2*exp(-a*sw(1,ll))) + 2/h;
            Bmat(1:ndf:ndf*(nel-1)+1) = [shg' du db];
