...
%
% Revision adds the provision for multiple constituents all tied together
% For now, I will only do 3 constituents, and the pattern will emerge later
...
%%
    case 3 % Stiffness and internal force vector
        ...
        for je = 1:lint
            ...
            u3  = ul(:,2*nelm+1:3*nelm)*shl;
            l1  = ul(:,3*nelm+1:4*nelm)*shl;
            l2  = ul(:,4*nelm+1:5*nelm)*shl;
            l3  = ul(:,5*nelm+1:6*nelm)*shl;
            psi = ul(:,6*nelm+1:7*nelm)*shl;
        ...
        ElemK = [Zero   Zero   Zero -elemk   Zero   Zero  Zero
                 Zero   Zero   Zero   Zero -elemk   Zero  Zero
                 Zero   Zero   Zero   Zero   Zero -elemk  Zero
               -elemk   Zero   Zero   Zero   Zero   Zero elemk
                 Zero -elemk   Zero   Zero   Zero   Zero elemk
                 Zero   Zero -elemk   Zero   Zero   Zero elemk
                 Zero   Zero   Zero  elemk  elemk  elemk  Zero];
