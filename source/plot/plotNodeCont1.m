function plotNodeCont1(Coordinates, Contour, NodesOnElement, PlotID, elemlist, MNE_ID, varargin)
% Tim Truster
% 01/01/2014
% 
% Plot contour of nodal finite element field from a 1-D mesh
% Optional arguments are in {}, defaults are in ().
%
% Default usage (for copy/paste):
% plotNodeCont1(Coordinates,Contour,NodesOnElement,1,(1:size(NodesOnElement,1)),[1 0 0])
%
% Inputs:
...
for elemp = 1:length(elemlist)
    ...
    len = 5;
    knots = [-1 -.5 0 .5 1.0]';
    hcont = plot1DLagranlinecont(PatchPoints, ContourValues, nel, knots, len, elemp, hcont);
