function helem = plot3DLagransurfstre(P, Cont, nel, knots, numu, gridlin, ID, mateprop, compon,nelP,iel, elem, helem)
...
for j = 1:numu
    for i = 1:numu
        ...
        r = knots(ind,1);
        s = knots(ind,2);
        [SurPoint,CPL2D(i,j)] = LagrSurfacePointStre3(P,Cont,nel,r,s,t,3,mateprop,compon,nelP,iel);
        for dir = 1:3
