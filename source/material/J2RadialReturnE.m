function [sig_n1,C_n1,ee_n1,beta_n1,a_n1,s_n1,Cdev_n1] = J2RadialReturnE(deps_n1,ee_n,beta_n,a_n,mu,bulk,K,H,sigy)
% Tim Truster
% 04/17/2012
...
%
% Inputs: deps_n1 = linearized incremental strain at step n+1 (current value) 
%                  (assumed to be computed using Bbar)
%         ee_n   = elastic strain at step n
