function  [fn1,detf,fi,df,fn,shpc] = kine3m(shpr,ul,uld,nel,sflag)
...
%         do i = 1,2
          detf(1) = fn1(1,1)*fn1(2,2)*fn1(3,3) ...
                    + fn1(1,2)*fn1(2,3)*fn1(3,1) ...
                    + fn1(1,3)*fn1(2,1)*fn1(3,2) ...
                    - fn1(3,1)*fn1(2,2)*fn1(1,3) ...
                    - fn1(3,2)*fn1(2,3)*fn1(1,1) ...
                    - fn1(3,3)*fn1(2,1)*fn1(1,2);
          detf(2) = fn(1,1)*fn(2,2)*fn(3,3) ...
                    + fn(1,2)*fn(2,3)*fn(3,1) ...
                    + fn(1,3)*fn(2,1)*fn(3,2) ...
                    - fn(3,1)*fn(2,2)*fn(1,3) ...
                    - fn(3,2)*fn(2,3)*fn(1,1) ...
                    - fn(3,3)*fn(2,1)*fn(1,2);
%         end do ! i

        detfi     = 1.d0/detf(1);
        fi(1,1) = (fn1(2,2)*fn1(3,3)-fn1(3,2)*fn1(2,3))*detfi;
        fi(1,2) = (fn1(3,2)*fn1(1,3)-fn1(1,2)*fn1(3,3))*detfi;
        fi(1,3) = (fn1(1,2)*fn1(2,3)-fn1(2,2)*fn1(1,3))*detfi;

        fi(2,1) = (fn1(2,3)*fn1(3,1)-fn1(3,3)*fn1(2,1))*detfi;
        fi(2,2) = (fn1(3,3)*fn1(1,1)-fn1(1,3)*fn1(3,1))*detfi;
        fi(2,3) = (fn1(1,3)*fn1(2,1)-fn1(2,3)*fn1(1,1))*detfi;

        fi(3,1) = (fn1(2,1)*fn1(3,2)-fn1(3,1)*fn1(2,2))*detfi;
        fi(3,2) = (fn1(3,1)*fn1(1,2)-fn1(1,1)*fn1(3,2))*detfi;
        fi(3,3) = (fn1(1,1)*fn1(2,2)-fn1(2,1)*fn1(1,2))*detfi;
