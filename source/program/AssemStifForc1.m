...
if numComp > 0
    ...
    Kfd1(EGDOFTic,EGDOFTac) = Kfd1(EGDOFTic,EGDOFTac) + ElemKTemp2;
    ...
    Kff1(EGDOFTic,EGDOFTic) = Kff1(EGDOFTic,EGDOFTic) + ElemKTemp2;
    ...
    Kfd1(EGDOFTi,EGDOFTa) = Kfd1(EGDOFTi,EGDOFTa) + ElemK(ELDOFTi,ELDOFTa);
    Kff1(EGDOFTi,EGDOFTi) = Kff1(EGDOFTi,EGDOFTi) + ElemK(ELDOFTi,ELDOFTi);
