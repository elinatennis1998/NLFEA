...
Ksdd2(sinddd+1:sinddd+lEGDOFTa^2,:) = combvec(EGDOFTa,EGDOFTa)';
sinddd = sinddd + lEGDOFTa^2;
Ksdf2(sinddf+1:sinddf+lEGDOFTa*lEGDOFTi,:) = combvec(EGDOFTa,EGDOFTi)';
sinddf = sinddf + lEGDOFTa*lEGDOFTi;
Ksff2(sindff+1:sindff+lEGDOFTi^2,:) = combvec(EGDOFTi,EGDOFTi)';
