...
% phases. Taylor model. Set up for any number of grains or elements within
% them. More comments have been added
% At the bottom, I list the minimal required arrays for the analysis.
...
bCrys = 3;2;6;24;1;12; % number of elements along edge of a grain
...
TFS =  2; % FE  3; % Sachs 1; %Taylor 4; % Combo 5; % Fine Scale
...
clearinter = 1;0;
if clearinter
KeyList = {'Coordinates','NodesOnElement','RegionOnElement','MateT',...
    'MatTypeTable','ProbType','NodeBC','numBC','CoordinatesI','BoundXmid',...
    'nummatCG','MaterTypeNum','DHist','FHist','SHist','SEHist','GrainSig',...
    'GrainEps','GrainVol','numSI','PSPS'};
if isOctave
    wholething = [{'-x'},KeyList];
    clear(wholething{:})
else
    wholething = [{'-except'},KeyList];
