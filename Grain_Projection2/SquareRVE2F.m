...
% them. More comments have been added; using fine scale fluxes from 3x3
% grid
...
TFS = 5; % Fine Scale 1; %Taylor 4; % Combo 2; % FE 3; % Sachs 
factorTS = .5;1;0;.25;.75; % factor for Taylor vs Sachs; 1 means Taylor
