...
for mat2 = 1:nummat
    for mat1 = 1:mat2
        ...
        if numSIi > 0 % Create PBC pairs first
            ...
            SurfacesIi = ReverseFacets(SurfacesIi,NodesOnElement,Coordinates,numSIi,2);
            ...
            [NodesOnElement,RegionOnElement,~,numnp,numel,nummat,MatTypeTable,MateT,Coordinates,...
             ...
             FormMPCCZ(MPCListNew,numMPCnew,NodesOnLinkNew,NodesOnLinknumNew,CouplerNodes,...
                    ...
                    22,0,CZstiff,MPCList,NodesOnLink,NodesOnLinknum,MatTypeTable,MateT);
...
[MPCList,numMPC,CouplerNodes] = CleanMPC(MPCListNew,numMPCnew,CouplerNodes,2);
