...
Coordinates = [2 1 
               ...
               7 9
               3 7];
                                                                           %Coordinates-spatial coordinates of the nodes
RegionOnElement = [1]';                                                    %Region ID of an Element 
NodesOnElement = [1 2 3 4];                                                %List of nodes connected to elements
numel = 1;                                                                 %total number of elements in the mesh
...
NodeBC = [1 1 0
          1 2 0
          2 2 0];                                                          %[node# dof magnitude]

NodeLoad = [3 1 100];                                                      %[node# dof mafnitude]
